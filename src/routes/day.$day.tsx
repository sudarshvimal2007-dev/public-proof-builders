        ...
        <GlassCard className="mt-4 p-6 lg:p-8">
          {completed ? (
            <div className="relative text-center">
              ...
              <Link
                to="/dashboard"
                className="group mt-6 inline-flex min-h-13 items-center gap-2 rounded-2xl bg-[var(--gradient-primary)] px-6 text-sm font-bold text-primary-foreground"
              >
                BACK TO DASHBOARD
                <ArrowRight
            ...
            <>
              ...
              <button
                ...
                className="mt-6 flex min-h-13 w-full items-center justify-center gap-2 rounded-2xl bg-[var(--gradient-primary)] text-sm font-bold tracking-wide text-primary-foreground shadow-[0_16px_40px_-18px_var(--color-primary)] transition-all active:scale-[0.99] disabled:cursor-not-allowed disabled:bg-none disabled:bg-secondary disabled:text-muted-foreground disabled:shadow-none"
              >
