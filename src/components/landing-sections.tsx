    ...
    <section id="how-it-works" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-28">
      ...
      <div ref={ref} className="relative mt-12 lg:mt-16">
        ...
        <div className="absolute top-0 bottom-0 left-[19px] w-px bg-border lg:top-[38px] lg:right-0 lg:bottom-auto lg:left-0 lg:h-px lg:w-auto">
          <div
            className="h-full w-full origin-top bg-[var(--gradient-primary)] lg:origin-left"
            style={{
              transform: `scale${window === undefined ? "Y" : ""}(1)`,
              height: "100%",
              maskImage: "none",
        ...
        <GlassCard className="p-6 lg:p-8">
          ...
          <div className="relative mt-6">
            <div className="h-2 overflow-hidden rounded-full bg-foreground/10">
              <div
                className="h-full rounded-full bg-[var(--gradient-primary)] shadow-[0_0_18px_-2px_var(--color-primary)]"
                style={{
                  width: visible ? `${pct}%` : "0%",
        ...
        <Reveal delay={80}>
          <GlassCard tilt className="p-6 lg:p-8" as="article">
            <div className="flex items-center gap-4">
              <span className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-[var(--gradient-primary)] text-lg font-bold text-primary-foreground">
                {student.initials}
              </span>
              <div className="min-w-0">
...
export function MagneticButton({
  ...
  return (
    <Link
      ...
      className="group inline-flex min-h-13 items-center gap-2 rounded-full bg-[var(--gradient-primary)] px-7 text-sm font-bold tracking-wide text-primary-foreground shadow-[0_18px_45px_-18px_var(--color-primary)] transition-[transform,box-shadow] duration-300 hover:shadow-[0_22px_60px_-16px_var(--color-primary)] active:scale-[0.98]"
    >
      {children}
      <ArrowRight
        className="h-4 w-4 transition-transform group-hover:translate-x-1"
