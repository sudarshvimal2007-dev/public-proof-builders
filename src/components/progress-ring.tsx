      ...
      <svg width={size} height={size} className="-rotate-90" aria-hidden="true">
        ...
        <circle
          ...
          style={{
            ...
            filter:
              "drop-shadow(0 0 8px color-mix(in oklab, var(--color-primary) 55%, transparent))",
          }}
        />
      </svg>
...
export function ProgressBar({
  ...
  return (
    <div className={`h-2.5 overflow-hidden rounded-full bg-foreground/10 ${className}`}>
      <div
        className="h-full rounded-full grad-primary shadow-[0_0_16px_-3px_var(--color-primary)]"
        style={{
